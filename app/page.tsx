...
import GitHubTrendingDashboard from './components/GitHubTrendingDashboard'
...
function ProjectCard({ project }: { project: (typeof projects)[0] }) {
  return (
    <div className="border border-[#e5e5e5] p-5 flex flex-col gap-2 h-full min-h-[120px]">
    ...
    <main className="max-w-3xl mx-auto px-6">
      ...
      <section className="pt-24 pb-20 border-b border-gray-100">
        ...
        <div className="flex flex-wrap gap-6 font-mono text-sm">
          ...
          <a
            href="https://linkedin.com/in/mirandacavalie"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-600 hover:text-black transition-colors flex items-center gap-1.5"
          >
          ...
          <a
            href="mailto:mirandacavalie@gmail.com"
            className="text-gray-600 hover:text-black transition-colors flex items-center gap-1.5"
          >
      ...
      {/* ── Trending AI/ML Dashboard ──────────────────────────────────────── */}
      <GitHubTrendingDashboard />
      ...
      <section className="pt-16 pb-16 border-b border-gray-100">
        ...
        <div className="divide-y divide-gray-100">
          {experiences.map((exp) => (
            <div
              key={exp.company}
              className="py-4 grid grid-cols-1 sm:grid-cols-[1fr_1fr_2fr_auto] gap-1 sm:gap-4 items-baseline"
            >
        ...
        <div className="divide-y divide-gray-100">
          {education.map((ed) => (
            <div key={ed.school} className="py-4 grid grid-cols-1 sm:grid-cols-[2fr_1fr] gap-1 sm:gap-4 items-baseline">
              ...
              {ed.detail && (
                <span className="font-mono text-xs text-gray-400">{ed.detail}</span>
              )}
            </div>
          ))}
        </div>
